...
cancelDialogueBox(){
  ...
  submitForm(): void {
    if (!this.excelImportDto.vatAmountPercentage || !this.excelImportDto.customFormValue) {
      alert('Please fill in all required fields.');
      return; 
    }
    console.log("Custom Plus Excel:", this.excelImportDto.customPlusExcel);
    console.log("VAT Amount Percentage:", this.excelImportDto.vatAmountPercentage);
    console.log("Custom Form Value:", this.excelImportDto.customFormValue);
    this.closeModal1();
  }
  closeModal1(): void {
