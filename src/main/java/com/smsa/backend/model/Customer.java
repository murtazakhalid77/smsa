...
public class Customer {
    ...
    Customer(final String accountNumber, final String invoiceCurrency, final Region region, final Double smsaServiceFromSAR, final String email, final String ccMail, final String nameArabic, final String nameEnglish, final String VatNumber, final String address, final String poBox, final String country, final Boolean status, final boolean isPresent, final Double smsaAdminChargesFromSAR) {
        ...
        this.smsaAdminChargesFromSAR = smsaAdminChargesFromSAR;
    }
    ...
    public Double getSmsaAdminChargesFromSAR() {
        return this.smsaAdminChargesFromSAR;
    }
    ...
    public void setSmsaAdminChargesFromSAR(final Double smsaAdminChargesFromSAR) {
        this.smsaAdminChargesFromSAR = smsaAdminChargesFromSAR;
    }
    ...
    public boolean equals(final Object o) {
        if (o == this) {
            ...
            if (!other.canEqual(this)) {
                ...
                label167: {
                    Object this$smsaAdminChargesFromSAR = this.getSmsaAdminChargesFromSAR();
                    Object other$smsaAdminChargesFromSAR = other.getSmsaAdminChargesFromSAR();
                    if (this$smsaAdminChargesFromSAR == null) {
                        if (other$smsaAdminChargesFromSAR == null) {
                            break label167;
                        }
                    } else if (this$smsaAdminChargesFromSAR.equals(other$smsaAdminChargesFromSAR)) {
                        break label167;
                    }
    ...
    public int hashCode() {
        ...
        Object $smsaAdminChargesFromSAR = this.getSmsaAdminChargesFromSAR();
        result = result * 59 + ($smsaAdminChargesFromSAR == null ? 43 : $smsaAdminChargesFromSAR.hashCode());
    ...
    public String toString() {
        return "Customer(accountNumber=" + this.getAccountNumber() + ", invoiceCurrency=" + this.getInvoiceCurrency() + ", region=" + this.getRegion() + ", smsaServiceFromSAR=" + this.getSmsaServiceFromSAR() + ", email=" + this.getEmail() + ", ccMail=" + this.getCcMail() + ", nameArabic=" + this.getNameArabic() + ", nameEnglish=" + this.getNameEnglish() + ", VatNumber=" + this.getVatNumber() + ", address=" + this.getAddress() + ", poBox=" + this.getPoBox() + ", country=" + this.getCountry() + ", status=" + this.getStatus() + ", isPresent=" + this.isPresent() + ", smsaAdminChargesFromSAR=" + this.getSmsaAdminChargesFromSAR() + ")";
    }
    ...
    public static class CustomerBuilder {
        ...
        public CustomerBuilder smsaAdminChargesFromSAR(final Double smsaAdminChargesFromSAR) {
            this.smsaAdminChargesFromSAR = smsaAdminChargesFromSAR;
            return this;
        }

        public Customer build() {
            return new Customer(this.accountNumber, this.invoiceCurrency, this.region, this.smsaServiceFromSAR, this.email, this.ccMail, this.nameArabic, this.nameEnglish, this.VatNumber, this.address, this.poBox, this.country, this.status, this.isPresent, this.smsaAdminChargesFromSAR);
        }

        public String toString() {
            return "Customer.CustomerBuilder(accountNumber=" + this.accountNumber + ", invoiceCurrency=" + this.invoiceCurrency + ", region=" + this.region + ", smsaServiceFromSAR=" + this.smsaServiceFromSAR + ", email=" + this.email + ", ccMail=" + this.ccMail + ", nameArabic=" + this.nameArabic + ", nameEnglish=" + this.nameEnglish + ", VatNumber=" + this.VatNumber + ", address=" + this.address + ", poBox=" + this.poBox + ", country=" + this.country + ", status=" + this.status + ", isPresent=" + this.isPresent + ", smsaAdminChargesFromSAR=" + this.smsaAdminChargesFromSAR + ")";
        }
    }
}
