...
public class InvoiceDetails {
    ...
    public Long getCustomDeclarationNumber() {
    ...
    public void setCustomDeclarationNumber(final Long customDeclarationNumber) {
        this.customDeclarationNumber = customDeclarationNumber;
    }
    ...
    public static class InvoiceDetailsBuilder {
        ...
        public InvoiceDetailsBuilder customDeclarationNumber(final Long customDeclarationNumber) {
            this.customDeclarationNumber = customDeclarationNumber;
            return this;
        }
